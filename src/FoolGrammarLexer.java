...
public class FoolGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CLASS", "INT", "BOOL", "VOID", "IF", "ELSE", "RETURN", "TRUE", "FALSE", 
			"COMMA", "IDENTIFIER", "NUMBER", "ASSIGN", "PLUS", "TIMES", "EQUALS", 
			"LESS", "GREATER", "NOT", "AND", "OR", "SEMICOLON", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
